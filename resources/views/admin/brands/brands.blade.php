            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a style="max-width: 150px;" href="{{ url('admin/add-edit-brand')}}" class="btn btn-block btn-primary">Add Brand</a>
                    ...
                    <table  id="table_id" class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img src="{{ asset('front/images/brand_images/'.$brand['brand_image']) }}">
                          </td>
                          <td>
                             {{ $brand['name']}}
                          </td>
