<!DOCTYPE html>
 ...
 <body>
   <div class="loader">
            <img src="{{ asset('front/images/loaders/loaders.gif') }}" alt="loading..." />
         </div>
                ...
                <div class="row auth align-items-center">
                    <div class="col-md-6 px-5">
                        <div class="heading">
                            ...
                            <h3 class="section-subheading text-muted">Login as a Chef or a Cook</h3>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="button">
                                     ...
                                     <p class="section-subheading text-muted mb-4">
                                      ...
                                      <a href="{{ url('vendor/register') }}">Signup</a>
                                     </p>
                                     <p class="section-subheading text-muted mb-4">
                                         Have you forgotten your password?
                                      <a href="{{ url('vendor/forgot-password') }}">Please reset</a>
                                     </p>
                                </div>
                            </div>
