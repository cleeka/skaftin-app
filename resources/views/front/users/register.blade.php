                ...
                <div class="row auth align-items-center">
                    <div class="col-md-6 p-0">
                        <div class="auth-image">
                            <img src="{{ asset('front/assets/img/auth-2.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 px-5">
                        <div class="heading">
                            <h2 class="section-heading text-uppercase">Signup</h2>
                            <h3 class="section-subheading text-muted">Signup as a customer</h3>
                        </div>
                             ...
                             @if(Session::has('error_message'))
                                     ...
                                     <form class="d-flex" id="registerForm" action="javascript:;" method="post" >@csrf
